/// SENTENCIAS GET, POST , PUT Y DELETE ///
...
function postCar(){
    ...
    console.log(cajas);
    $.ajax({
        url:"http://150.230.36.168:8080/api/Car/save",
        type:"POST",
        datatype:"JSON",
...
function putCar(idBotonActualizar){
    ...
    $.ajax({
        url:"http://150.230.36.168:8080/api/Car/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteCar(idBoton){
    ...
    $.ajax({
        url:"http://150.230.36.168:8080/api/Car/"+idBoton,
        type:"DELETE",
        datatype:"JSON",
...
function getGamaRelacion(){
    $.ajax({
        url:"http://150.230.36.168:8080/api/Gama/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
