...
function getReservaciones(){
    $.ajax({
        url:"http://150.230.36.168:8080/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
...
function postReservaciones(){
    ...
    $.ajax({
        url:"http://150.230.36.168:8080/api/Reservation/save",
        type:"POST",
        datatype:"JSON",
...
function putReservaciones(idBotonActualizar){
    ...
    if ($("#status").val().length==0){
        alert("Campo obligatorio para actualizar la reserva");
    ...
    $.ajax({
        url:"http://150.230.36.168:8080/api/Reservation/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteReservaciones(idBoton){
    ...
    $.ajax({
        url:"http://150.230.36.168:8080/api/Reservation/"+idBoton,
        type:"DELETE",
        datatype:"JSON",
...
function getReservaciones_Car(){
    $.ajax({
        url:"http://150.230.36.168:8080/api/Car/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function getReservaciones_Client(){
    $.ajax({
        url:"http://150.230.36.168:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
