...
function getMensajes(){
    $.ajax({
        url:"http://150.230.36.168:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
...
function postMensajes(){
    ...
    $.ajax({
        url:"http://150.230.36.168:8080/api/Message/save",
        type:"POST",
        datatype:"JSON",
...
function putMensajes(idBotonActualizar){
    ...
    if ($("#messageText").val().length==0){
        alert("Campo obligatorio para actualizar el mensaje");
    ...
    $.ajax({
        url:"http://150.230.36.168:8080/api/Message/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteMensajes(idBoton){
    ...
    $.ajax({
        url:"http://150.230.36.168:8080/api/Message/"+idBoton,
        type:"DELETE",
        datatype:"JSON",
